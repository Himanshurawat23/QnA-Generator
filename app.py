...
def main():
    ...
    st.set_page_config(page_title="Question and Answer Generator Powered By Groq", page_icon="📝")
    ...
    # Set page title
    st.title("Question and Answer Generator Powered By Groq")
    ...
    topic = st.sidebar.text_input(
        "Enter Topic", 
        placeholder="Physics, Chemistry,Maths etc."
    )
